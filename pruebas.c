...
int *avanza_derecha(int laberinto_aux[][7], int fila, int columna, int posicion_columna, int posicion_fila_columna_bandera[]){
    if ((laberinto_aux[fila + 1][columna] != 1) && (fila != 7)){
        laberinto_aux[fila][columna] = 2;
        posicion_fila_columna_bandera[0] = (fila += 1);
        posicion_fila_columna_bandera[1] = posicion_columna;
    ...
    return avanza_derecha(laberinto_aux,fila,columna + 1, posicion_columna, posicion_fila_columna_bandera);
}

int *avanza_izquierda(int laberinto_aux[][7], int fila, int columna, int posicion_columna, int posicion_fila_columna_bandera[]){
    if ((laberinto_aux[fila + 1][columna] != 1) && (fila != 7)){
        laberinto_aux[fila][columna] = 2;
        posicion_fila_columna_bandera[0] = (fila += 1);
        posicion_fila_columna_bandera[1] = posicion_columna;
    ...
    return avanza_izquierda(laberinto_aux,fila,columna - 1, posicion_columna, posicion_fila_columna_bandera);
}
